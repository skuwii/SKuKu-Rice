...
Item {
    ...
    ListModel {
        ...
        // ListElement { title: "Stewart AI"; target: "stewart"; icon: "󰚩"; desc: "Voice assistant integration."; preview: "previews/preview_stewart.png" } // disabled (no AI)
    }
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Rectangle { 
                                ...
                                border.color: root.surface2
                                border.width: 1
                                Text { anchors.centerIn: parent; text: ""; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: root.s(20); color: root.text } 
                            }
                            ...
                            Rectangle {
                                ...
                                Item {
                                    ...
                                    Item { 
                                        ...
                                        width: root.s(36)
                                        height: root.s(36)
                                        Text { anchors.centerIn: parent; text: model.icon; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: root.s(22); color: root[model.clr] } 
                                    }
                            ...
                            ColumnLayout {
                                ...
                                RowLayout { 
                                    ...
                                    Rectangle { 
                                        ...
                                        Text { anchors.centerIn: parent; text: model.icon; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: root.s(14); color: isSelected ? root.ambientBlue : root.text } 
                                    } 
                                    Text { 
                                        text: model.title
                                        font.family: "JetBrains Mono"

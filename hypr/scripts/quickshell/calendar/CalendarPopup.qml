                            ...
                            Rectangle {
                                ...
                                ColumnLayout {
                                    ...
                                    Text { 
                                        ...
                                        font.family: "JetBrainsMono Nerd Font"; font.pixelSize: Math.round(18 * window.sf)
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            Text { anchors.centerIn: parent; text: "󰃭"; font.family: "JetBrainsMono Nerd Font"; color: window.text; font.pixelSize: Math.round(16 * window.sf) }
                            MouseArea { 
                        ...
                        Rectangle {
                            ...
                            Text { anchors.centerIn: parent; text: ""; font.family: "JetBrainsMono Nerd Font"; color: window.text; font.pixelSize: Math.round(16 * window.sf) }
                        ...
                        Rectangle {
                            ...
                            Text { anchors.centerIn: parent; text: "+"; font.family: "JetBrainsMono Nerd Font"; color: diaryMa.containsMouse ? window.mauve : window.text; font.pixelSize: Math.round(32 * window.sf) }
                            MouseArea { 
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        MouseArea { 
                            ...
                            Text { 
                                anchors.centerIn: parent; text: ""; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: Math.round(18 * window.sf)
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            Text { anchors.centerIn: parent; text: ""; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: Math.round(18 * window.sf); color: window.textAccent }
                        }
                        ...
                        Rectangle {
                            ...
                            RowLayout {
                                ...
                                Text { text: ""; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: Math.round(14 * window.sf); color: schLinkMa.containsMouse ? window.base : window.text }
                            }
                                        ...
                                        Item {
                                            ...
                                            ColumnLayout {
                                                ...
                                                RowLayout {
                                                    ...
                                                    spacing: Math.round(8 * window.sf)
                                                    Text { text: "󰅐"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: Math.round(14 * window.sf); color: classNode.isActive ? window.mauve : window.overlay1 }
                                                ...
                                                RowLayout {
                                                    ...
                                                    spacing: Math.round(8 * window.sf)
                                                    Text { text: ""; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: Math.round(14 * window.sf); color: classNode.isPast ? window.surface2 : window.peach }

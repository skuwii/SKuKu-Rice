                        ...
                        Rectangle {
                            ...
                            Item {
                                ...
                                ColumnLayout {
                                    ...
                                    Text { Layout.alignment: Qt.AlignHCenter; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: window.s(32); color: window.crust; text: "󰤨" }
                            ...
                            Rectangle {
                                ...
                                Item {
                                    ...
                                    RowLayout {
                                        ...
                                        Text { font.family: "JetBrainsMono Nerd Font"; font.pixelSize: window.s(20); color: window.crust; text: icon }
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            anchors.centerIn: parent
                            spacing: window.s(8)
                            Text { font.family: "JetBrainsMono Nerd Font"; font.pixelSize: window.s(18); color: window.activeMode === "eth" ? window.crust : window.text; text: "󰈀"; Behavior on color { ColorAnimation{duration:200} } }
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            anchors.centerIn: parent
                            spacing: window.s(8)
                            Text { font.family: "JetBrainsMono Nerd Font"; font.pixelSize: window.s(18); color: window.activeMode === "wifi" ? window.crust : window.text; text: "󰤨"; Behavior on color { ColorAnimation{duration:200} } }
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            anchors.centerIn: parent
                            spacing: window.s(8)
                            Text { font.family: "JetBrainsMono Nerd Font"; font.pixelSize: window.s(18); color: window.activeMode === "bt" ? window.crust : window.text; text: "󰂯"; Behavior on color { ColorAnimation{duration:200} } }
